...
public class WifiDirectAutoAccept {
    ...
    private WiFiDirectUtils callback;
     ...
     */
    WifiDirectAutoAccept(Context context, WiFiDirectUtils callback, WifiP2pManager m, WifiP2pManager.Channel c) {
 ...
 * manager and channel.
 */
    public WifiDirectAutoAccept(WiFiDirectUtils callback, WifiP2pManager manager, WifiP2pManager.Channel channel) {
        this(null, callback, manager, channel);
    }
 ...
 */
    public WifiDirectAutoAccept(Context context, WiFiDirectUtils callback) {
 ...
 */
    private class DialogListenerProxy {
        ...
        public void onConnectionRequested(WifiP2pDevice device, WifiP2pConfig config) {
            ...
            if (callback.WiFiStatus == callback.WIFI_CONNECTED || callback.WiFiStatus == callback.WIFI_CONNECTING) {
            	Log.i(TAG, "Refusing another connection.");
            	return;
            }
            ...
            manager.connect(channel, config, new ActionListener() {
                ...
                public void onSuccess() {
                	...
                	callback.WiFiStatus = callback.WIFI_CONNECTING;
                }

                @Override
                public void onFailure(int reason) {
                	Log.e(TAG,"Error connecting: "+ reason);
                	callback.WiFiStatus = callback.WIFI_DISCONNECTED;
                }
            });
        }
